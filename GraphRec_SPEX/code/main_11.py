...
def train(model, device, train_loader, train_data2, user_path_indx, alluser_path_index, trust_batch_size, epoch,
    ...
    for data_r in train_loader:
        ...
        # path_index = set(path_index) & avail_path
        if len(path_index) > trust_batch_size:
            path_index = random.sample(path_index, trust_batch_size)
        # else:
        #     no_user_path_index = random.sample(avail_path-path_index,trust_batch_size-len(path_index))
        #     path_index = path_index | set(no_user_path_index)
        # avail_path = avail_path - set(path_index)
